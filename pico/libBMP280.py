...
# issues with getting i2c to work on raspberry pi 2 resolved here:
# https://github.com/Boeeerb/PiGlow/issues/19


# code refactored into class from:
...
class BMP280():
    ...
    def TakeMeasurement(self):
        ...
        # commenting this out doesn't seem to be an issue
        #time.sleep(0.5)
